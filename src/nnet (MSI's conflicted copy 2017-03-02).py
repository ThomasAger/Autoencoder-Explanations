        ...
        for m in range(len(models)):
            ...
            if get_scores:
                ...
                for y in range(len(y_pred)):
                    ...
                    f1_array.append(f1_score(y_test[m][y], y_pred[y], average=None))
...
def main(data_type, classification_task, file_name, init_vector_path, hidden_activation, is_identity, amount_of_finetune,
         ...
         output_activation, cs, deep_size, classification, direction_count, lowest_amt, loss, development, reached_max):
    cv_splits = cross_val
...
highest_amt = 10
loss="binary_crossentropy"
init_vector_path = "../data/"+data_type+"/nnet/spaces/films200-keywords.txt"
