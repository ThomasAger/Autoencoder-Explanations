...
space = util.io.import2dArray("../data/movies/nnet/spaces/films200.npy")
ft_space = util.io.import2dArray("../data/movies/nnet/spaces/mds-nodupeCV1S0 SFT0 allL010010 LR kappa KMeans CA400 MC1 MS0.4 ATS1000 DS800FT BOCFi NT[200]tanh300V1.2L0.npy")
entity_names = util.io.import1dArray("../data/movies/nnet/spaces/entitynames.txt")
...
cluster_names = util.io.import2dArray("../data/" + data_type + "/cluster/dict/" + file_name + ".txt", "s")
ranking = util.io.import2dArray("../data/" + data_type + "/rank/numeric/" + file_name + ".txt")
entity_names = util.io.import1dArray("../data/" + data_type + "/nnet/spaces/entitynames.txt")
top_x = 5
cluster_length = 3
cluster_ids = None
...
ranking = util.io.import2dArray("../data/" + data_type + "/nnet/clusters/" + file_name + ".txt")
...
def getSimilarClusters(cluster_dict_1, cluster_dict_2, trim_amt, file_name, data_type, threshold_for_stopping, threshold_for_stopping_1):
    ...
    for c in range(len(sorted_orig_indexes)):
        ...
        lines.append(line)
        print(line)
    util.io.write1dArray(lines, "../data/" + data_type + "/investigate/" + file_name + str(trim_amt) + ".txt")
"""
data_type = "movies"
