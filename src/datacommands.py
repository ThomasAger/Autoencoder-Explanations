    ...
    for splits in range(cv_splits):
        ...
        for d in range(len(deep_size)):
            ...
            #for x in range(len([0])):
                ...
                #vector_path_replacement = "places100"
...
python $SRCPATH/pipelinesvm.py ""movies" "genres" "movies mds" "../data/movies/nnet/spaces/films200-genres.txt" "tanh" True 1 True False 0.8 False 1 3 0.5 0.001 3000 1 100 "sigmoid" 0.2 "[200]" "genres" 10 100 "binary_crossentropy" False True False "adagrad" None 1000 20 0 True
